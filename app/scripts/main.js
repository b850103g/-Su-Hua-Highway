...
function on_text_change(name){
	...
	// debugger
// 	var wording = `
// 本人${name}願意簽署這份文件，因為蘇花公路改善路段實在太危險，現階段(${now})不適合沒有路權的二輪車輛行駛。並且認為在不合法的情況下騎乘上去非常沒有素質。
// 倘若將來，高速公路開放紅黃牌摩托車行駛，與快速道路開放白牌摩托車行駛，本人${name}同意，絕對不在上敘道路使用摩托車，若違反的話，願意上傳自爆菊花影片到社群網站上，表示個人素質與爆菊花決心。
// `
